...
//       <p style={{fontSize:'14px',padding:'5px 0',color:'green'}}>From ₹ 3,000</p>
//       <p style={{fontSize:'14px',padding:'5px 0',color:'gray'}}>upto ₹ 9,000</p></div>
//       <div><img src='assets/images/ads.avif' alt="Image 1" style={{width:'100%',height:'250px',objectFit:'contain',marginBottom:'10px'}}></img></div>
...
// export default MultiCarousells
